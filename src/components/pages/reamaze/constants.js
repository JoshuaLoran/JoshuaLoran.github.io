...
export const subHeader = "Better Conversations. Happier Customers.";

export const titleDescription = "An integrated customer service, live chat, and helpdesk platform for online businesses.";

////////////////////////////////////
// Content for the Reamaze worktree
////////////////////////////////////
export const workTreeData = {
  topHeading: "Technical Responsibilties",
  topList: [
    "Developed frontend design and implementation of tools",
    "Built and/or modified models, views, controllers, and various features in a RoR envirnoment",
    "Utilized React and JQuery in an SSR RoR setup",
  ...
  linkUrl: "https://www.reamaze.com/"
};

// Tech icons used in the Re:amaze project
export const reamazeIcons = [
  {
    icon: rubyIcon,
